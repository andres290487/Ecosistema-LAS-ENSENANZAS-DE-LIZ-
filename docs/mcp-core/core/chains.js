...
export function getNetworkConfig(network = "tron") {
...
export function getSupportedIlks(network = "tron") {
    return Object.values(getNetworkConfig(network).ilks);
}
export function getSupportedPsmMarkets(network = "tron") {
    return Object.values(getNetworkConfig(network).psmMarkets);
}
export function getIlkConfig(ilk, network = "tron") {
...
export function getPsmMarketConfig(market, network = "tron") {
