import { z } from "zod";
import { getSupportedNetworks, getSupportedIlks, getSupportedPsmMarkets } from "./chains.js";
import * as services from "./services/index.js";
function asText(data) {
    return { content: [{ type: "text", text: services.utils.formatJson(data) }] };
}
...
export function registerUsddTools(server) {
    ...
    server.registerTool("get_wallet_address", {
        ...
        try {
            return asText({ network, address: services.getWalletAddress(network) });
        }
        catch (error) {
    ...
    server.registerTool("get_protocol_overview", {
        ...
        try {
            return asText(await services.getProtocolOverview(network));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("get_oracle_status", {
        ...
        try {
            return asText(await services.getOracleStatus(network, ilk));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("get_psm_status", {
        ...
        try {
            return asText(await services.getPsmStatus(network, market));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("get_user_vaults", {
        ...
        try {
            const ids = await services.getUserVaultIds(network, address);
            const queriedOwner = address || await services.getProxyAddress(network, false);
    ...
    server.registerTool("get_vault_summary", {
        ...
        try {
            return asText(await services.getVaultSummary(network, BigInt(cdpId)));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("analyze_vault_risk", {
        ...
        try {
            return asText(await services.analyzeVaultRisk(network, BigInt(cdpId)));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("get_savings_status", {
        ...
        try {
            return asText(await services.getSavingsStatus(network));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("open_vault", {
        ...
        try {
            return asText(await services.openVault(network, ilk));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("mint_usdd", {
        ...
        try {
            return asText(await services.drawUsdd(network, BigInt(cdpId), amount));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("repay_usdd", {
        ...
        try {
            return asText(await services.repayUsdd(network, BigInt(cdpId), amount));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("withdraw_collateral", {
        ...
        try {
            return asText(await services.withdrawCollateral(network, BigInt(cdpId), ilk, amount));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("close_vault", {
        ...
        try {
            return asText(await services.closeVault(network, BigInt(cdpId), ilk, amountToFree));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("psm_swap_to_usdd", {
        ...
        try {
            return asText(await services.sellGemForUsdd(network, market, amount));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("psm_swap_from_usdd", {
        ...
        try {
            return asText(await services.buyGemWithUsdd(network, market, amount));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("deposit_savings", {
        ...
        try {
            return asText(await services.depositSavings(network, amount));
        }
        catch (error) {
            return asError(error);
        }
    ...
    server.registerTool("withdraw_savings", {
        ...
        try {
            return asText(await services.withdrawSavings(network, amount));
        }
        catch (error) {
            return asError(error);
        }
